...
public class UserController {
    ...
    public IMoocJSONResult registOrLogin(@RequestBody Users user) throws Exception {
        ...
        if (usernameIsExist) {
            ...
            user.setFaceImage("M00/00/00/rBUAAlxsBp-AdHAGAAGf56445Tg882_80x80.png");
            user.setFaceImageBig("M00/00/00/rBUAAlxsBp-AdHAGAAGf56445Tg882.png");
    ...
    public IMoocJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
        ...
        String userFacePath = "F:\\small-chat\\" + userBO.getUserId() + "userface64.png";
    ...
    public IMoocJSONResult queryFriendRequests(String userId) {
        ...
        // 1. 查询用户接受到的朋友申请
        List<FriendRequestVO> userRequests = userService.queryFriendRequestList(userId);
        return IMoocJSONResult.ok(userRequests.stream().distinct().collect(Collectors.toList()));
    }
    /**
